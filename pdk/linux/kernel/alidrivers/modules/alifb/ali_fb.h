...
#include <linux/ump/ump_kernel_interface_ref_drv.h>
#endif
...
#ifdef CONFIG_FB_UMP_ALI
    ump_dd_handle ump_wrapped_buffer[2][3];
#endif
...
#ifdef CONFIG_FB_UMP_ALI
extern int (*disp_get_ump_secure_id) (struct fb_info *info, struct alifb_info *g_fbi,
