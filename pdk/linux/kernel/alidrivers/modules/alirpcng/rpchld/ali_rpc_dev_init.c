...
char usr_osd_scale=0;
char usr_ignore_alpha =0;
#endif
...
#ifdef GOBIAN_OSDSCALE //francis.cheng
	usr_osd_scale=board_info->avinfo.osd_ratio;
	usr_ignore_alpha=board_info->avinfo.framebuffer_ignore_alpha;
	printk("usr_ignore_alpha=%d \n",usr_ignore_alpha);
#endif
