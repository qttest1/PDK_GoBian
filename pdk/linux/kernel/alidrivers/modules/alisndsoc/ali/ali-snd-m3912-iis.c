...
static __init int m3912_iis_dev_probe(struct platform_device *pdev)
{
...
static __exit int m3912_iis_dev_remove(struct platform_device *pdev)
{
   	printk(KERN_ERR "in function %s line %d\n", __FUNCTION__, __LINE__);
