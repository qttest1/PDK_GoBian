...
static int __init asoc_m39xx_platform_probe(struct platform_device *pdev)
{
...
static int __exit asoc_m39xx_platform_remove(struct platform_device *pdev)
{
	printk(KERN_ERR "in Function %s, line %d \n", __FUNCTION__,__LINE__);
...
static struct platform_driver asoc_m39xx_pcm_driver = {
	...
	.remove = asoc_m39xx_platform_remove,
};
