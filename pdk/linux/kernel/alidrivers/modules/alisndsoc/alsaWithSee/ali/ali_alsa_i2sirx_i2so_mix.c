...
static int __init i2sirx_i2so_mix_dev_probe(struct platform_device *pdev)
{
    printk("%s,%d\n", __FUNCTION__,__LINE__);
...
static int __exit i2sirx_i2so_mix_dev_remove(struct platform_device *pdev)
{
    printk("%s,%d\n", __FUNCTION__,__LINE__);
...
static struct platform_driver platform_i2sirx_i2so_mix_driver = 
{
    ...
    .remove = i2sirx_i2so_mix_dev_remove,
};
