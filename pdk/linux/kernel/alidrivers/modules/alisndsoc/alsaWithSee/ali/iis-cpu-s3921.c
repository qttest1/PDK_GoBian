...
#endif
static __init int iis_cpu_s3921_dev_probe(struct platform_device *pdev)
{
...
static __exit int iis_cpu_s3921_dev_remove(struct platform_device *pdev)
{
	printk(ALSAPRINT "in function %s line %d\n", __FUNCTION__, __LINE__);
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 0))	
...
static struct platform_driver iis_cpu_s3921_dev_driver = {
	...
	.remove = iis_cpu_s3921_dev_remove,
	.driver = {
