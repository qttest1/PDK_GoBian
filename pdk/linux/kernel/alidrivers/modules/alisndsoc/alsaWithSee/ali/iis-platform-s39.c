...
{   
	...
	{
	    mod_timer(&alsa_period_timer, jiffies + msecs_to_jiffies(50));
...
static int __init iis_platform_s39_dev_probe(struct platform_device *pdev)
{
...
static int __exit iis_platform_s39_dev_remove(struct platform_device *pdev)
{
	printk(ALSAPRINT "in Function %s, line %d \n", __FUNCTION__,__LINE__);
...
static struct platform_driver iis_platform_s39_dev_driver = {
	...
	.remove = iis_platform_s39_dev_remove,
};
