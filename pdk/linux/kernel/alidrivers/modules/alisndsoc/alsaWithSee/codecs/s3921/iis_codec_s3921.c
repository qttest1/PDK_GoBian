...
*                                                                                                                    *
********************************************************************/
static int __init iis_codec_s3921_dev_probe(struct platform_device *pdev)
{
...
static int __exit iis_codec_s3921_dev_remove(struct platform_device *pdev)
{
	printk(KERN_ERR "in function %s line %d\n", __FUNCTION__, __LINE__);
...
static struct platform_driver iis_codec_s3921_dev_driver = {
	...
	.remove		= iis_codec_s3921_dev_remove,
	.driver		= {
