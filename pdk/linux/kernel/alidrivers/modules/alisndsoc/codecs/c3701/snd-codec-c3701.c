...
*                                                                                                                    *
********************************************************************/
static int __init c3701_codec_probe(struct platform_device *pdev)
{
	return snd_soc_register_codec(&pdev->dev,
			&soc_codec_dev_c3701, codec_dai_c3701,  ARRAY_SIZE(codec_dai_c3701));
}

static int __exit c3701_codec_remove(struct platform_device *pdev)
{
