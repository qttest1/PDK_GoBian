...
*                                                                                                                    *
********************************************************************/
static int __init s3921_codec_probe(struct platform_device *pdev)
{
...
static int __exit s3921_codec_remove(struct platform_device *pdev)
{
     printk(KERN_ERR "in function %s line %d\n", __FUNCTION__, __LINE__);
