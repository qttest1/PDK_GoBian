...
MALI_STATIC_INLINE u32 mali_hw_core_register_read_status_ALI(struct mali_hw_core *core, u32 relative_address)
{
	u32 stat = mali_hw_core_register_read(core, relative_address);
	return (stat & 0xf);
}
