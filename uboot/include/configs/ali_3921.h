...
#if defined(CONFIG_ALI_SD)//for gobian
#define PART_NAME_AUD_CODE  "ae_bin.ubo"
#define PART_NAME_KERNEL        "main_bin.ubo"
#define PART_NAME_SEE           "see_bin.ubo"
#define PART_NAME_RAMDISK       "ramdisk.ubo"
#define PART_NAME_ROOTFS       "rootfs"
#define PART_NAME_MAIN_BIN      "kernel.ubo"
#define PART_NAME_RECOVERY      "recovery"
#define PART_NAME_RECOVERYBAK   "recoverybak"
#define PART_NAME_BM            "bootmedia.ubo"
#else
